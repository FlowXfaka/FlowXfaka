    ...
    <div class="page-shell">
        ...
        <main class="container storefront-main">
            ...
            <section class="storefront-panel storefront-product-panel" data-product-section>
                <div class="catalog-products-stack" data-product-body data-selected-category="{{ $selectedCategorySlug }}" data-current-category="{{ $selectedCategorySlug }}">
                    <section class="catalog-products-panel is-active" data-category-panel="{{ $selectedCategorySlug }}">
                        @include(\App\Support\StorefrontTheme::view('partials.storefront-products', $storefrontThemeKey), ['products' => $activeProducts])
                    </section>
                </div>
                <div class="catalog-products-loader" data-catalog-loader hidden aria-hidden="true">
                    <div class="catalog-products-loader__dialog">
                        <div class="catalog-products-loader__surface" aria-hidden="true">
                            <span class="catalog-products-loader__halo"></span>
                            <span class="catalog-products-loader__ring catalog-products-loader__ring--outer"></span>
                            <span class="catalog-products-loader__ring catalog-products-loader__ring--inner"></span>
                            <span class="catalog-products-loader__core"></span>
                        </div>
                        <div class="catalog-products-loader__label" data-catalog-loader-label>正在切换分类...</div>
                    </div>
                </div>
